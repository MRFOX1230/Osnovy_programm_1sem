...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 150, 521, 161));
        gridLayout = new QGridLayout(layoutWidget);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        label_stor1 = new QLabel(layoutWidget);
        label_stor1->setObjectName(QString::fromUtf8("label_stor1"));
        QFont font1;
        font1.setFamily(QString::fromUtf8("Segoe UI Variable Small Semibol"));
        ...
        label_stor2 = new QLabel(layoutWidget);
        label_stor2->setObjectName(QString::fromUtf8("label_stor2"));
        ...
        label_angle = new QLabel(layoutWidget);
        ...
        lineEdit_stor1 = new QLineEdit(layoutWidget);
        lineEdit_stor1->setObjectName(QString::fromUtf8("lineEdit_stor1"));
        ...
        lineEdit_stor2 = new QLineEdit(layoutWidget);
        lineEdit_stor2->setObjectName(QString::fromUtf8("lineEdit_stor2"));
        ...
        layoutWidget1->setGeometry(QRect(560, 120, 281, 191));
        gridLayout_2 = new QGridLayout(layoutWidget1);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        gridLayout_2->setContentsMargins(0, 0, 0, 0);
        label_result = new QLabel(layoutWidget1);
        ...
        label_s = new QLabel(layoutWidget1);
        ...
        lineEdit_s = new QLineEdit(layoutWidget1);
        ...
        layoutWidget2->setGeometry(QRect(230, 330, 298, 47));
        ...
        menuP_S_4->setObjectName(QString::fromUtf8("menuP_S_4"));
